...
public class EditGroupDialog extends Screen {
    ...
    protected void init() {
        ...
        this.nameBox.setValue(this.group.name != null ? this.group.name : "Category");
        ...
        this.iconIdBox.setValue(this.group.iconId != null ? this.group.iconId : "diamond");
        ...
        if ("SOLID".equals(this.colorMode)) {
            ...
            this.color1Box.setValue(this.group.color1 != null ? this.group.color1 : "#FFAA00");
            ...
            this.color2Box.setValue(this.group.color2 != null ? this.group.color2 : "#FF5555");
        ...
        this.addRenderableWidget(new ModernButton(centerX - 100, startY + 116, 95, 20, Component.literal("Save"), () -> {
            this.group.name = this.nameBox.getValue().trim();
            this.group.iconType = this.iconType;
            this.group.iconId = this.iconIdBox.getValue().trim();
            this.group.colorMode = this.colorMode;
            if (this.color1Box != null) this.group.color1 = this.color1Box.getValue().trim();
            if (this.color2Box != null) this.group.color2 = this.color2Box.getValue().trim();
            this.onSave.run();
